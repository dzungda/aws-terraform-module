...
```hcl
module "server_sg_1" {
  source = "https://github.com/dzungda/aws-terraform-module/new/master/terraform-aws-sg"
...
## Examples
https://github.com/dzungda/terraform-aws-sg

## How to add/update rules/groups?

Rules and groups are defined in [rules.tf](https://git.vti.com.vn/vticloud/vti_cloud_iac/-/blob/master/modules/terraform-aws-sg/rules.tf). Run `update_groups.sh` when content of that file has changed to recreate content of all automatic modules.
